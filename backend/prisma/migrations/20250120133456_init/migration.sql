/*
  ...
  - You are about to drop the column `confirm` on the `Friend` table. All the data in the column will be lost.
...
CREATE TABLE "new_Friend" (
    ...
    "confirm_status" TEXT NOT NULL DEFAULT 'FALSE',
...
INSERT INTO "new_Friend" ("created_at", "friend_id", "id", "user_id") SELECT "created_at", "friend_id", "id", "user_id" FROM "Friend";
DROP TABLE "Friend";
